...
let TransactionService = class TransactionService {
    ...
    async payment(user, payload) {
        try {
            ...
            console.log(...oo_oo(`2933852340_35_6_35_36_4`, availableProducts));
            const totalAmount = availableProducts.reduce((total, item) => total + (item.price * item.paidQuantity), 0);
            console.log(...oo_oo(`2933852340_39_6_39_30_4`, totalAmount));
            return (await DB).transaction(async (transaction) => {
                if (payload.paymentMethod.toLowerCase() === 'wallet') {
                    ...
                    console.log(...oo_oo(`2933852340_49_10_49_30_4`, balance));
    ...
    async transactionWebhook(deposit) {
        try {
            ...
            console.log(...oo_oo(`2933852340_184_8_184_33_4`, deposit.data));
