...
let WaitListRepository = class WaitListRepository {
    ...
    find(criteria) {
        return this.waitListEntity.findAndCountAll({
            where: criteria,
        });
    }
};
WaitListRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('WAITLIST_ENTITY')),
